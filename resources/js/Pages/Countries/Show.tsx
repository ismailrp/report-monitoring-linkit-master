...
export default function Show({ country }: Props) {
    return (
        <AppLayout>
            <Head title={`Country Details - ${country.country}`} />

            <div className="mb-8 border-4 border-black bg-emerald-600 p-6 text-white shadow-[8px_8px_0_0_rgba(0,0,0,1)]">
                <div className="flex justify-between items-center">
                    <div>
                        <h1 className="text-4xl font-black uppercase tracking-widest">{country.country}</h1>
